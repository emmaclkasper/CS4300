...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="lsar">Home</a></li>
...
<div class="container">
  <h2><fmt:message key="home_admin.tit" /></h2>          
  <table class="table table-hover">
    <thead>
      <tr>
        <th><fmt:message key="home_admin.title" /></th>
        <th><fmt:message key="home_admin.cat" /></th>
        <th><fmt:message key="home_admin.price" /></th>
        <th><fmt:message key="home_admin.aut" /></th>
         <th><fmt:message key="home_admin.del" /></th>
      </tr>
    </thead>
    <tbody>
    <c:forEach items="${articles}" var="ar">
        ...
        <td>${ar.prix }</td>
         <td>${ar.auteur}</td>
         <td><a href="lsar?submit=del&id=${ar.id}"> <i  class="glyphicon glyphicon-trash"></i></a> </td>
      </tr>
    </c:forEach>
