...
<li class=""><a href="lsar">Home</a></li>
      ...
      <li class="active"><a href="lscmd"><fmt:message key="home_admin.order" /></a></li>
...
<div class="container">
  <h2><fmt:message key="ls_cmd.tit" /></h2>          
  <table class="table table-hover">
    <thead>
      <tr>
        <th><fmt:message key="ls_cmd.nom" /></th>
        <th><fmt:message key="ls_cmd.mail" /></th>
        <th><fmt:message key="ls_cmd.des" /></th>
        <th><fmt:message key="ls_cmd.dat" /></th>
        <th><fmt:message key="ls_cmd.del" /></th>
      </tr>
    </thead>
    <tbody>
   <c:forEach items="${cmd}" var="cm">
          <tr>
        <td>${ cm.nomc}</td>
        <td>${cm.mail }</td>
        <td>${cm.design }</td>
         <td>${cm.date}</td>
         <td><a href="lscmd?submit=del&id=${cm.numCmd}"><i class="	glyphicon glyphicon-trash"></i></a></td>
      </tr>
    </c:forEach>
    </tbody>
  </table>
